...
export interface ServerListPaneProps {
  ...
  className?: string
  /** 'workspace' renders text-label sidebar rows; 'classic' renders Discord-style icon stack */
...
/* ── WorkspaceRow — used in workspace layoutMode ──────────────────────── */
...
/* ── WorkspaceRail — full workspace-mode render of ServerListPane ─────── */
...
function WorkspaceRail({
  ...
  onReorder,
  className,
}: Omit<ServerListPaneProps, 'layoutMode'>) {
...
export const ServerListPane = memo(function ServerListPane({
  ...
  // Workspace mode: delegate to the editorial sidebar renderer
  ...
  // Classic mode: Discord-style icon-stack
